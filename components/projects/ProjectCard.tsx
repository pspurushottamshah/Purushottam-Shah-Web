...
export default function ProjectCard({ project, index }: ProjectCardProps) {
    ...
    return (
        <motion.div
            ...
            className={`glass rounded-2xl p-6 hover-glow transition-smooth ${project.featured ? 'md:col-span-2 md:row-span-2' : ''
                }`}
        >
            {/* Header */}
            ...
            {/* Team Breakdown Chart (if available) */}
            {project.teamBreakdown && project.featured && (
                <div className="mb-6">
            ...
            <div className="mb-4">
                ...
                <div className="flex flex-wrap gap-2">
                    ...
                    {project.technologies.length > 4 && !isExpanded && (
            ...
            <button
                ...
                className="mt-4 w-full py-2 bg-electric/10 hover:bg-electric/20 text-electric font-semibold rounded-lg transition-smooth"
            >
